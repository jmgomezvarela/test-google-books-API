...
public class BooksSample {
  ...
  private static void queryGoogleBooks(JsonFactory jsonFactory, String query) throws Exception {
    ...
    for (Volume volume : volumes.getItems()) {
      ...
      System.out.println("==========");
      // Title.
      System.out.println("Titulo: " + volumeInfo.getTitle());
      System.out.println("Link: " + volumeInfo.getInfoLink());
      System.out.println("Fecha publicacion: " + volumeInfo.getPublishedDate());
      // Author(s).
